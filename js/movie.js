    ...
    movieDetail.innerHTML = `
      ...
      <div class="movie-detail-container">
        ...
        <div class="movie-detail-info">
          ...
          <p>
            ⏱️ Thời lượng:
            ${movie.runtime || "Chưa có"} phút
          </p>

          <p>
            🌍 Ngôn ngữ:
            ${movie.original_language || "Chưa có"}
          </p>
